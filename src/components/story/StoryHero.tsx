...
import { Play, Sparkles, Heart, Shield, Flame, BookOpen } from "lucide-react";
...
export const StoryHero: React.FC<StoryHeroProps> = ({ story, currentProgress }) => {
  ...
  return (
    <div className="relative w-full rounded-3xl overflow-hidden bg-zinc-950 border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.8)] my-4">
      ...
      <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-40 mix-blend-luminosity scale-105 transform pointer-events-none"
        style={{
        ...
        <div className="max-w-xl">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <div className="flex items-center gap-1 text-xs text-amber-400 font-semibold">
              ...
              <span>Interactive Visual Novel</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-white/5 border border-white/10 text-zinc-400">
              {story._count?.episodes || 10} Episodes
            </span>
            <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-purple-950/60 border border-purple-500/30 text-purple-300">
              4 Branching Endings
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              ...
              <span>
                {isStarted ? `Continue (Episode ${currentEp})` : "Start Story Free"}
              </span>
            </Link>
